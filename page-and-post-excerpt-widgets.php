...
class PageExcerptMulti extends WP_Widget {
	...
	function __construct() {
			...
			$this->WP_Widget('pageexcerptmulti', __('Page Excerpt', 'post-excerpt-widget'), $widget_ops);
	}
...
class PostExcerptMulti extends WP_Widget {
	...
	function __construct() {
			...
			$this->WP_Widget('postexcerptmulti', __('Post Excerpt', 'post-excerpt-widget'), $widget_ops);
	}
